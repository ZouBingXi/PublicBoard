<template>
  <div>
    <el-menu mode="horizontal" :default-active="type"  active-text-color="black" @select="changetype">
      <el-menu-item index="1">校园卡丢失</el-menu-item>
      <el-menu-item index="2">寻主</el-menu-item>
      <el-menu-item index="3">寻物</el-menu-item>
      <el-menu-item index="4">捞人</el-menu-item>
      <el-menu-item index="5">求助</el-menu-item>
    </el-menu>
    <article-pre-view
...
export default {
  ...
  methods:{
    getlist(){
      this.$axios.get("/news/viewDiffNews?typeid="+this.type+"&page="+this.currentpage+"&size="+this.pagesize)
          .then(({data})=>{
