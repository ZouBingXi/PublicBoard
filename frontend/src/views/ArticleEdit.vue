<template>
  ...
  <div id="background">
      ...
      <div id="edit-combo">
        ...
        <div id="input-form">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" label-position="top" class="demo-ruleForm">
            ...
            <el-form-item id="input-form-item2" label="类型" prop="type">
              <el-radio-group fill="#909399" v-model="ruleForm.type">
                <el-radio-button label="贴子"></el-radio-button>
                <el-radio-button label="话题"></el-radio-button>
              </el-radio-group>
            </el-form-item>

            <el-form-item id="input-form-item3" prop="newstype" v-show="ruleForm.type == '贴子'">
            ...
            <el-form-item id="input-form-item4" prop="subjecttype" v-show="ruleForm.type == '话题'">
              <el-radio-group fill="#909399" v-model="ruleForm.subjecttype">
        ...
        <div id="input-button">
          ...
          <el-button id="input-button2" type="danger" @click="gotoHome('ruleForm')">取消</el-button>
        </div>
      </div>
    </div>
    ...
    <!-- 放大图片 -->
    <div>
      <el-dialog id="img-enlarge" :visible.sync="dialogVisible" :modal-append-to-body="false">
